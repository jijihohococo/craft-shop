...
jQuery(document).ready(function () {
  ...
  if(x==size_li){									 	
		   jQuery('.featured .tm-message').show();
...
function mobileToggleMenu(){
	if ($(window).width() < 980)
	{
		...
		$(".header_search").insertBefore(".myaccount")
		...
		$(".header_search").insertBefore(".header_middle .account");
		$("#footer .mobile_togglemenu").remove();
	}	
}
...
function mobileToggleColumn(){
	if ($(window).width() < 980)
	{
		...
		$("#res-menu").insertBefore(".header_middle .account .header_search");
