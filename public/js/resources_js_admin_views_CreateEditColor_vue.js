        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return window.axios.get('colors/' + colorId + '/edit').then(function (response) {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* CLASS */
    ...
    type: "color",
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)([_ctx.errors && _ctx.errors.color_code ? 'form-control form-control-color is-invalid' : 'form-control form-control-color']),
