...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getCollections: function getCollections(page) {
      ...
      window.axios.get((0,_helpers_check__WEBPACK_IMPORTED_MODULE_1__.makeRoute)(this, page, 'collection') + page).then(function (response) {
        _this.getMainData(response);
      })["catch"](function (error) {
        (0,_helpers_check__WEBPACK_IMPORTED_MODULE_1__.errorResponse)(error, _this, 'read');
      });
    },
    searchCollections: function searchCollections(page) {
      var _this2 = this;

      window.axios.get((0,_helpers_check__WEBPACK_IMPORTED_MODULE_1__.makeRoute)(this, page, 'collection', 'search') + this.search + '&page=' + page).then(function (response) {
        _this2.getMainData(response);
      })["catch"](function (error) {
        (0,_helpers_check__WEBPACK_IMPORTED_MODULE_1__.errorResponse)(error, _this2, 'read');
      });
    }
  },
  mounted: function mounted() {
    this.getCollections(1);
    (0,_helpers_check__WEBPACK_IMPORTED_MODULE_1__.checkContentPermission)(this.content, 'create', this);
    (0,_helpers_check__WEBPACK_IMPORTED_MODULE_1__.checkContentPermission)(this.content, 'update', this);
    (0,_helpers_check__WEBPACK_IMPORTED_MODULE_1__.checkContentPermission)(this.content, 'delete', this);
  }
});
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* PROPS */
  , ["deleteArrayData", "onSelectAll", "onCancelAll", "lengthData"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), _hoisted_10, _hoisted_11, _hoisted_12, _hoisted_13, _hoisted_14])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tbody", null, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.collections.data, function (collection) {
    ...
    , ["objectData", "deleteArrayData", "objectArrayData"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
      innerHTML: _ctx.checkString(collection.name)
    }, null, 8
    /* PROPS */
    , _hoisted_15)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_v_lazy_image, {
      "class": "img-fluid",
      src: '/image/collection_images/' + collection.pic
    }, null, 8
    /* PROPS */
    , ["src"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
      innerHTML: _ctx.checkString(collection.created_at)
    }, null, 8
    /* PROPS */
    , _hoisted_16)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
      innerHTML: _ctx.checkString(collection.deleted_at)
    }, null, 8
    /* PROPS */
    , _hoisted_17)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_18, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_ViewButton, {
      data_name: collection.name,
      data_model: $data.content,
      data_id: collection.id
    }, null, 8
    /* PROPS */
    , ["data_name", "data_model", "data_id"]), _ctx.actions.update && collection.deleted_at == null ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_EditButton, {
      key: 0,
      content: $data.content,
