...
/* harmony import */ var v_lazy_image__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! v-lazy-image */ "./node_modules/v-lazy-image/dist/v-lazy-image.mjs");
/* harmony import */ var _helpers_check_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../helpers/check.js */ "./resources/js/admin/helpers/check.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    ...
    VLazyImage: v_lazy_image__WEBPACK_IMPORTED_MODULE_13__["default"]
  },
  data: function data() {
    return {
      content: 'Collection',
  ...
  methods: {
    freshPage: function freshPage() {
      this.getCollections((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.showPageNumber)(this.currentPage));
    },
    checkAuthorizeActions: function checkAuthorizeActions(actions) {
      return (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.checkActions)(actions);
    },
    checkUnauthorizeActions: function checkUnauthorizeActions(actions) {
      return (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.unauthorizedActions)(actions);
    },
    selectChecks: function selectChecks() {
      if (this.$refs.deleteCheck !== undefined) {
        (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.makeSelect)(this.$refs.deleteCheck, true);
      }
    },
    cancelChecks: function cancelChecks() {
      if (this.$refs.deleteCheck !== undefined) {
        (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.makeSelect)(this.$refs.deleteCheck, false);
      }
    },
    updateData: function updateData(object) {
      (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.deleteFromArray)(this.collections.data, object);
    },
    getCollections: function getCollections(page) {
      var _this = this;

      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.makeRoute)(this, page, 'collection') + page).then(function (response) {
        if (response.data.message == 'Loading') {
          (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.showSwalLoading)(_this);
        } else {
          _this.collections = response.data.collections;
          _this.actions.read = true;
        }
      })["catch"](function (error) {
        (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.errorResponse)(error, _this, 'read');
      });
    },
    searchCollections: function searchCollections(page) {
      var _this2 = this;

      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.makeRoute)(this, page, 'collection', 'search') + this.search + '&page=' + page).then(function (response) {
        if (response.data.message == 'Loading') {
          (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.showSwalLoading)(_this2);
        } else {
          _this2.collections = response.data.collections;
          _this2.actions.read = true;
        }
      })["catch"](function (error) {
        (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.errorResponse)(error, _this2, 'read');
      });
    }
  },
  mounted: function mounted() {
    this.getCollections(1);
    (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.checkContentPermission)(this.content, 'create', this);
    (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.checkContentPermission)(this.content, 'update', this);
    (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.checkContentPermission)(this.content, 'delete', this);
  }
});
