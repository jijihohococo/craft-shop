...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    freshPage: function freshPage() {
      this.getBrands((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.showPageNumber)(this.currentPage));
    },
    ...
    updateData: function updateData(object) {
      (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.deleteFromArray)(this.brands.data, object);
    },
    getBrands: function getBrands(page) {
      var _this = this;

      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.makeRoute)(this, page, 'brand') + page).then(function (response) {
    ...
    searchBrands: function searchBrands(page) {
      ...
      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.makeRoute)(this, page, 'brand', 'search') + this.search + '&page=' + page).then(function (response) {
        if (response.data.message == 'Loading') {
