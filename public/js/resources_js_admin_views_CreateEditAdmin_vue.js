...
/* harmony import */ var _components_SelectMultiple__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/SelectMultiple */ "./resources/js/admin/components/SelectMultiple.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    ...
    SelectMultiple: _components_SelectMultiple__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
  data: function data() {
    return {
      admin: _store__WEBPACK_IMPORTED_MODULE_4__.admin,
      header: '',
      content: 'Admin',
      roles: {},
      fields: {
    ...
    createAdmin: function createAdmin() {
      ...
      window.axios.post("admins", this.fields).then(function (response) {
        ...
        if (error.response.status == 422) {
          ...
          (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_1__.errorResponse)(error, _this2, 'create');
        }
      });
    },
    ...
    getAdminData: function getAdminData(adminId) {
      ...
      window.axios.get('admins/' + adminId + '/edit').then(function (response) {
        if (response.data.message == 'Loading') {
          ...
          _this4.fields.roles = (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_1__.mergeArray)(response.data.roles);
        }
      })["catch"](function (error) {
