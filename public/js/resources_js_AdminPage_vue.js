...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    checkMenus: function checkMenus() {
      ...
      return route in this.$props.dataRoutes || route.replace('_bin', '') in this.$props.dataRoutes || route.replace('.edit', '') in this.$props.dataRoutes || route.replace('.create', '') in this.$props.dataRoutes || route.replace('.variant', '') in this.$props.dataRoutes || route.replace('.stock', '') in this.$props.dataRoutes || route.replace('.stock.create', '') in this.$props.dataRoutes || route.replace('.stock.edit', '') in this.$props.dataRoutes || route == 'transaction' && this.$route.params.model !== null && (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_0__.getModel)(this.$route.params.model) in this.$props.dataRoutes;
    }
  }
});
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* CLASS */
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_router_link, {
      to: '/admin/' + route,
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)([$props.currentRoute == route || route + '_bin' == $props.currentRoute || route + '.variant' == $props.currentRoute || route + '.stock' == $props.currentRoute || route + '.stock.create' == $props.currentRoute || route + '.stock.edit' == $props.currentRoute || route + '.edit' == $props.currentRoute || route + '.create' == $props.currentRoute || _this.$route.params.model !== null && _this.$route.params.model == dataRoute ? 'nav-link active' : 'nav-link'])
    }, {
      "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
