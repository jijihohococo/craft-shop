...
/* harmony import */ var _admin_components_Loading__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./admin/components/Loading */ "./resources/js/admin/components/Loading.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  data: function data() {
    return {
      shop: _store_js__WEBPACK_IMPORTED_MODULE_3__.shop,
      currentYear: _store_js__WEBPACK_IMPORTED_MODULE_3__.currentYear
    };
  },
  components: {
    ...
    Loading: _admin_components_Loading__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  computed: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      shop: _store__WEBPACK_IMPORTED_MODULE_3__.shop,
    ...
    logout: function logout() {
      ...
      window.axios.post('logout').then(function (response) {
        if (response.data.message == 'Loading') {
          (0,_helpers_general__WEBPACK_IMPORTED_MODULE_2__.showSwalLoading)(_this);
        } else {
          window.location.href = "dashboard";
        }
      })["catch"](function (error) {
        (0,_helpers_check__WEBPACK_IMPORTED_MODULE_1__.errorResponse)(error, _this);
      });
    },
              ...
              case 0:
                window.axios.get("admin").then(function (response) {
                  if (response.data.message == 'Loading') {
                    ...
                    _this2.admin.changeData(response.data.admin);
                  }
                })["catch"](function (error) {
                  (0,_helpers_check__WEBPACK_IMPORTED_MODULE_1__.errorResponse)(error, _this2);
                });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    checkMenus: function checkMenus() {
      ...
      return route in this.$props.dataRoutes || route.replace('_bin', '') in this.$props.dataRoutes || route.replace('.edit', '') in this.$props.dataRoutes || route.replace('.create', '') in this.$props.dataRoutes || route.replace('.variant', '') in this.$props.dataRoutes || route.replace('.stock', '') in this.$props.dataRoutes || route.replace('.stock.create', '') in this.$props.dataRoutes || route.replace('.stock.edit', '') in this.$props.dataRoutes || route.replace('.price', '') in this.$props.dataRoutes || route.replace('.price.create', '') in this.$props.dataRoutes || route.replace('.price.edit', '') in this.$props.dataRoutes || route.replace('.currency_rate', '') in this.$props.dataRoutes || route.replace('.currency_rate.create', '') in this.$props.dataRoutes || route.replace('.currency_rate.edit', '') in this.$props.dataRoutes || route.replace('.currency_rate_transaction', '') in this.$props.dataRoutes || route.replace('.transaction', '') in this.$props.dataRoutes || this.$route.params.model !== undefined && (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_0__.getModel)(this.$route.params.model) in this.$props.dataRoutes;
    }
  }
});
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.currentRoute == 'login' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_router_view, {
    ...
    key: 1
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Preloader "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <div class=\"preloader flex-column justify-content-center align-items-center\">\n\t\t\t<img class=\"animation__shake\" :src=\"'/dist/img/AdminLTELogo.png'\" alt=\"AdminLTELogo\" height=\"60\" width=\"60\">\n\t\t</div> "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Navigation), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Menu), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Loading), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_router_view)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("footer", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("Copyright © " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.currentYear) + " ", 1
  /* TEXT */
  ), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.shop.data.name), 1
  /* TEXT */
  ), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(".")]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" All rights reserved. ")])])], 64
  /* STABLE_FRAGMENT */
  ));
}
...
var _hoisted_14 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, " Dashboard ", -1
/* HOISTED */
);
...
var _hoisted_17 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, " Logout ", -1
/* HOISTED */
);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Main Sidebar Container "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("aside", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Brand Logo "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_3, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.shop.data.name), 1
  /* TEXT */
  )]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Sidebar "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Sidebar user panel (optional) "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
    src: '/dist/img/user2-160x160.jpg',
    "class": "img-circle elevation-2",
    alt: "User Image"
  }, null, 8
  /* PROPS */
  , _hoisted_7)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_8, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", _hoisted_9, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.admin.data.name), 1
  /* TEXT */
  )])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Sidebar Menu "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("nav", _hoisted_10, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("ul", _hoisted_11, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", _hoisted_12, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_router_link, {
    to: "/admin/dashboard",
  ...
  /* PROPS */
  , ["currentRoute", "dataRoutes"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", _hoisted_15, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    role: "button",
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  })]), _hoisted_5]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Right navbar links "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("ul", _hoisted_6, [_hoisted_7, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", _hoisted_8, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", _hoisted_9, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    type: "checkbox",
  ...
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelCheckbox, $data.dark]]), _hoisted_10])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" /.navbar ")], 64
  /* STABLE_FRAGMENT */
  );
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* CLASS */
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_router_link, {
      to: '/admin/' + route,
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)([$props.currentRoute == route || route + '_bin' == $props.currentRoute || route + '.variant' == $props.currentRoute || route + '.stock' == $props.currentRoute || route + '.stock.create' == $props.currentRoute || route + '.stock.edit' == $props.currentRoute || route + '.price' == $props.currentRoute || route + '.price.create' == $props.currentRoute || route + '.price.edit' == $props.currentRoute || route + '.currency_rate' == $props.currentRoute || route + '.currency_rate.create' == $props.currentRoute || route + '.currency_rate.edit' == $props.currentRoute || route + '.currency_rate_transaction' == $props.currentRoute || route + '.edit' == $props.currentRoute || route + '.create' == $props.currentRoute || route + '.transaction' == $props.currentRoute || _this.$route.params.model !== undefined && _this.$route.params.model == dataRoute ? 'nav-link active' : 'nav-link'])
    }, {
      "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
