    ...
    createItemStock: function createItemStock() {
      ...
      window.axios.post("save_item_variant_stocks/" + this.itemVariant.id, this.fields).then(function (response) {
        ...
        if (error.response.status == 422) {
          ...
          (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_2__.errorResponse)(error, _this3, 'create');
        }
      });
    },
              ...
              case 0:
                window.axios.get('create_item_variant_stocks/' + itemVariantId).then(function (response) {
                  if (response.data.message == 'Loading') {
                    ...
                    _this4.itemColor = (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_2__.getItemColor)(response.data);
              ...
              case 0:
                window.axios.get('item_variant_stocks/' + itemStockId + '/edit').then(function (response) {
                  if (response.data.message == 'Loading') {
                    ...
                    _this5.itemColor = (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_2__.getItemColor)(response.data);
                    _this5.stock = _this5.itemColor + "'s Stock";
                    _this5.header = "Update " + _this5.stock;
                  }
                })["catch"](function (error) {
                  (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_2__.errorResponse)(error, _this5, 'update');
                });
