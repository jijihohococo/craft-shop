...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getCurrencies: function getCurrencies(page) {
      ...
      window.axios.get((0,_helpers_check__WEBPACK_IMPORTED_MODULE_0__.makeRoute)(this, page, 'currency') + page).then(function (response) {
    ...
    searchCurrencies: function searchCurrencies(page) {
      ...
      window.axios.get((0,_helpers_check__WEBPACK_IMPORTED_MODULE_0__.makeRoute)(this, page, 'currency', 'search') + this.search + '&page=' + page).then(function (response) {
