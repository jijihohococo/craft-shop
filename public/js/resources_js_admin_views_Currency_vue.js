...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    freshPage: function freshPage() {
      this.getCurrencies((0,_helpers_check__WEBPACK_IMPORTED_MODULE_12__.showPageNumber)(this.currentPage));
    },
    ...
    updateData: function updateData(object) {
      (0,_helpers_check__WEBPACK_IMPORTED_MODULE_12__.deleteFromArray)(this.currencies.data, object);
    },
    getCurrencies: function getCurrencies(page) {
      var _this = this;

      window.axios.get((0,_helpers_check__WEBPACK_IMPORTED_MODULE_12__.makeRoute)(this, page, 'currency') + page).then(function (response) {
    ...
    searchCurrencies: function searchCurrencies(page) {
      ...
      window.axios.get((0,_helpers_check__WEBPACK_IMPORTED_MODULE_12__.makeRoute)(this, page, 'currency', 'search') + this.search + '&page=' + page).then(function (response) {
        if (response.data.message == 'Loading') {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  , ["deleteArrayData", "objectArrayData", "routeName", "mainData", "onFreshData"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" /.card-header "), $data.actions.read ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    ...
    lengthData: $data.currencies.data.length,
    ref: "deleteAll"
  }, null, 8
  /* PROPS */
  , ["deleteArrayData", "onSelectAll", "onCancelAll", "lengthData"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), _hoisted_10, _hoisted_11, _hoisted_12, _hoisted_13])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tbody", null, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.currencies.data, function (currency) {
    ...
    /* PROPS */
    , ["objectData", "deleteArrayData", "objectArrayData"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(currency.name), 1
    /* TEXT */
