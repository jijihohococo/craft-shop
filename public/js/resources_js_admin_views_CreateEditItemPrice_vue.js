    ...
    createItemPrice: function createItemPrice() {
      ...
      window.axios.post("save_item_variant_prices/" + this.itemVariant.id, this.fields).then(function (response) {
        if (response.data.message == 'Loading') {
          ...
          _this3.$router.push({
            path: '/admin/item/price/' + _this3.itemVariant.id
          });
        }
      })["catch"](function (error) {
        if (error.response.status == 422) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return window.axios.get('get_available_currencies').then(function (response) {
                  if (response.data.message == 'Loading') {
...
var _hoisted_8 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", null, "Currency", -1
/* HOISTED */
);
...
var _hoisted_13 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", null, "Price", -1
/* HOISTED */
);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  , ["httpStatus", "title", "description"])) : _ctx.actions[_ctx.current] ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("form", {
    ...
    onSubmit: _cache[1] || (_cache[1] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function ($event) {
      return !isNaN(_this.$route.params.id) ? $options.updateItemPrice() : $options.createItemPrice();
    }, ["prevent"]))
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [_hoisted_9, ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.currencies, function (currency) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
          value: currency.used_currency_id
        }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(currency.used_currency), 9
        /* TEXT, PROPS */
        , _hoisted_10);
      }), 256
      /* UNKEYED_FRAGMENT */
  ...
  /* PROPS */
  , ["value", "onInput"]), _ctx.errors && _ctx.errors.currency_id ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("strong", _hoisted_11, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.errors.currency_id[0]), 1
  /* TEXT */
  ...
  /* CLASS */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.fields.price]]), _ctx.errors && _ctx.errors.price ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("strong", _hoisted_14, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.errors.price[0]), 1
  /* TEXT */
