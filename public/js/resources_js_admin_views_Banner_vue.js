...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getBanners: function getBanners(page) {
      ...
      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_13__.makeRoute)(this, page, 'banner') + "?page=" + page).then(function (response) {
    ...
    searchBanners: function searchBanners(page) {
      ...
      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_13__.makeRoute)(this, page, 'banner', 'search') + '?search=' + this.search + '&page=' + page).then(function (response) {
        if (response.data.message == 'Loading') {
