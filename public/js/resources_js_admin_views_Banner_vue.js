...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    freshPage: function freshPage() {
      this.getBanners((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.showPageNumber)(this.currentPage));
    },
    ...
    updateData: function updateData(object) {
      (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.deleteFromArray)(this.banners.data, object);
    },
    getBanners: function getBanners(page) {
      var _this = this;

      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.makeRoute)(this, page, 'banner') + page).then(function (response) {
    ...
    searchBanners: function searchBanners(page) {
      ...
      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_14__.makeRoute)(this, page, 'banner', 'search') + this.search + '&page=' + page).then(function (response) {
        if (response.data.message == 'Loading') {
