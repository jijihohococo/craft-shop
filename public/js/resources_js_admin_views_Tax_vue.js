...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    freshPage: function freshPage() {
      this.getTaxes((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_13__.showPageNumber)(this.currentPage));
    },
    ...
    updateData: function updateData(object) {
      (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_13__.deleteFromArray)(this.taxes.data, object);
    },
    getTaxes: function getTaxes(page) {
      var _this = this;

      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_13__.makeRoute)(this, page, 'tax') + page).then(function (response) {
    ...
    searchTaxes: function searchTaxes(page) {
      ...
      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_13__.makeRoute)(this, page, 'tax', 'search') + this.search + '&page=' + page).then(function (response) {
        if (response.data.message == 'Loading') {
  ...
  created: function created() {
    this.getTaxes(1);
    (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_13__.checkContentPermission)(this.content, 'read', this);
