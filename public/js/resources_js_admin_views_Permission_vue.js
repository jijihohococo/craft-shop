...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    freshPage: function freshPage() {
      this.getPermissions((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_13__.showPageNumber)(this.currentPage));
    },
    ...
    updateData: function updateData(object) {
      (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_13__.deleteFromArray)(this.permissions.data, object);
    },
    getPermissions: function getPermissions(page) {
      var _this = this;

      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_13__.makeRoute)(this, page, 'permission') + page).then(function (response) {
    ...
    searchPermissions: function searchPermissions(page) {
      ...
      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_13__.makeRoute)(this, page, 'permission', 'search') + this.search + '&page=' + page).then(function (response) {
        if (response.data.message == 'Loading') {
