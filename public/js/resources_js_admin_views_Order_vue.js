...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    checkUnauthorizeActions: function checkUnauthorizeActions(actions) {
      return (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_5__.unauthorizedActions)(actions);
    },
    searchOrders: function searchOrders(page) {
      var _this = this;

      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_5__.makeRoute)(this, page, 'order', 'search') + this.search + '&page=' + page).then(function (response) {
        if (response.data.message == 'Loading') {
          (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_5__.showSwalLoading)(_this);
        } else {
    ...
    getOrders: function getOrders(page) {
      ...
      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_5__.makeRoute)(this, page, 'order') + page).then(function (response) {
        if (response.data.message == 'Loading') {
          (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_5__.showSwalLoading)(_this2);
        } else {
