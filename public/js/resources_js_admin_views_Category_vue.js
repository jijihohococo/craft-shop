...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    freshPage: function freshPage() {
      this.getCategories((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_12__.showPageNumber)(this.currentPage));
    },
    ...
    updateData: function updateData(object) {
      (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_12__.deleteFromArray)(this.categories.data, object);
    },
    getCategories: function getCategories(page) {
      var _this = this;

      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_12__.makeRoute)(this, page, 'category') + page).then(function (response) {
    ...
    searchCategories: function searchCategories(page) {
      ...
      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_12__.makeRoute)(this, page, 'category', 'search') + this.search + '&page=' + page).then(function (response) {
        if (response.data.message == 'Loading') {
