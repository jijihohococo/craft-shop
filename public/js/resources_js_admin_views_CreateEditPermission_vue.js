        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_3__.checkContentPermission)(_this.content, _this.current, _this);
    ...
    updatePermission: function updatePermission() {
      ...
      window.axios.put("permissions/".concat(this.$route.params.id), this.fields).then(function (response) {
        ...
        if (error.response.status == 422) {
          ...
          (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_3__.errorResponse)(error, _this4, 'update');
        }
      });
    },
