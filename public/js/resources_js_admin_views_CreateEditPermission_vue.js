    ...
    createPermission: function createPermission() {
      ...
      window.axios.post("permissions", this.fields).then(function (response) {
        ...
        if (error.response.status == 422) {
          ...
          (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_4__.errorResponse)(error, _this3, 'create');
        }
      });
    },
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                window.axios.get('permissions/' + permissionId + '/edit').then(function (response) {
                  if (response.data.message == 'Loading') {
                    (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_4__.showSwalLoading)(_this5);
                  } else {
                  ...
                  (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_4__.errorResponse)(error, _this5, 'update');
                });
