...
/* harmony import */ var _components_Select__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/Select */ "./resources/js/admin/components/Select.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      current: null,
      contents: ['Permission', 'Shop', 'Admin', 'Banner', 'Category', 'Subcategory', 'Brand', 'Item', 'ItemStock', 'ItemPrice', 'Role', 'Target', 'User', 'Currency', 'Tax', 'Attribute', 'Color', 'Country', 'Order', 'Promotion', 'Collection', 'SocialMedia'],
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              (0,_helpers_check__WEBPACK_IMPORTED_MODULE_3__.checkContentPermission)(_this.content, _this.current, _this);
  ...
  methods: {
    ...
    createPermission: function createPermission() {
      ...
      window.axios.post("permissions", this.fields).then(function (response) {
        ...
        if (error.response.status == 422) {
          ...
          (0,_helpers_check__WEBPACK_IMPORTED_MODULE_3__.errorResponse)(error, _this3, 'create');
        }
      });
    },
    updatePermission: function updatePermission() {
      ...
      window.axios.put("permissions/".concat(this.$route.params.id), this.fields).then(function (response) {
        if (response.data.message == 'Loading') {
          (0,_helpers_general__WEBPACK_IMPORTED_MODULE_4__.showSwalLoading)(_this4);
        } else {
        ...
        if (error.response.status == 422) {
          ...
          (0,_helpers_check__WEBPACK_IMPORTED_MODULE_3__.errorResponse)(error, _this4, 'update');
        }
      });
    },
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                window.axios.get('permissions/' + permissionId + '/edit').then(function (response) {
                  if (response.data.message == 'Loading') {
                    (0,_helpers_general__WEBPACK_IMPORTED_MODULE_4__.showSwalLoading)(_this5);
                  } else {
                  ...
                  (0,_helpers_check__WEBPACK_IMPORTED_MODULE_3__.errorResponse)(error, _this5, 'update');
                });
...
var _hoisted_10 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", null, "Content", -1
/* HOISTED */
);
...
var _hoisted_14 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", null, "Access", -1
/* HOISTED */
);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* PROPS */
  , ["header", "back_links"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [$data.actions[$data.current] == false ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_Error, {
    key: 0,
  ...
  /* CLASS */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.fields.name]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_9, [_hoisted_10, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Select, {
  ...
  /* PROPS */
  , ["options", "value", "onInput"]), $data.errors && $data.errors.model ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("strong", _hoisted_12, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.errors.model[0]), 1
  /* TEXT */
  )) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_13, [_hoisted_14, _hoisted_15, ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.permissions, function (permission) {
    ...
    /* PROPS */
    , _hoisted_16), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelCheckbox, $data.checkedAction]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
