...
/* harmony import */ var _helpers_check_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../helpers/check.js */ "./resources/js/admin/helpers/check.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    checkAuthorizeActions: function checkAuthorizeActions(actions) {
      return (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_6__.checkActions)(actions);
    },
    checkUnauthorizeActions: function checkUnauthorizeActions(actions) {
      return (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_6__.unauthorizedActions)(actions);
    },
    getData: function getData(responseData) {
      this.item_stocks = responseData.item_stocks;
      this.itemColor = (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_6__.getItemColor)(responseData);
    ...
    searchItemStocks: function searchItemStocks(page) {
      ...
      window.axios.get('search_item_variant_stocks/' + this.$route.params.item_varaint_id + '?page=' + page).then(function (response) {
        if (response.data.message == 'Loading') {
          (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_6__.showSwalLoading)(_this);
        } else {
    ...
    getItemStocks: function getItemStocks(page) {
      ...
      window.axios.get('item_variant_stocks/' + this.$route.params.item_varaint_id + '?page=' + page).then(function (response) {
        if (response.data.message == 'Loading') {
          (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_6__.showSwalLoading)(_this2);
        } else {
          _this2.getData(response.data);
        }
      })["catch"](function (error) {
        (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_6__.errorResponse)(error, _this2, 'read');
      });
    }
  },
  created: function created() {
    this.getItemStocks(1);
    (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_6__.checkContentPermission)('ItemStock', 'create', this);
    (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_6__.checkContentPermission)('ItemStock', 'update', this);
  }
});
