...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    freshPage: function freshPage() {
      this.getRoles((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_12__.showPageNumber)(this.currentPage));
    },
    ...
    updateData: function updateData(object) {
      (0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_12__.deleteFromArray)(this.roles.data, object);
    },
    getRoles: function getRoles(page) {
      var _this = this;

      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_12__.makeRoute)(this, page, 'role') + page).then(function (response) {
    ...
    searchRoles: function searchRoles(page) {
      ...
      window.axios.get((0,_helpers_check_js__WEBPACK_IMPORTED_MODULE_12__.makeRoute)(this, page, 'role', 'search') + this.search + '&page=' + page).then(function (response) {
        if (response.data.message == 'Loading') {
